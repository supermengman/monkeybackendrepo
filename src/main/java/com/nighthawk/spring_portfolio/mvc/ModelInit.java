...
public class ModelInit {  
    ...
    CommandLineRunner run() {  // The run() method will be executed after the application starts
        return args -> {
            ...
            Level[] levels = {
                new Level(null, "Level 0", 0, List.of(categoryMap.get("2D Arrays")), "This is the 2018 FRQ Part A", "2018FRQA.javat", 6),
                new Level(null, "Level 1", 1, List.of(categoryMap.get("2D Arrays")), "This is the 2018 FRQ Part B", "2018FRQB.javat", 5),
